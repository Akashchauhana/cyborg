...
const Hero = () => {
    return (
      <section className="w-[90%] h-96 xl:ml-16 m-5 rounded-3xl overflow-hidden bg-[url('/src/components/image/banner-bg.jpg')] bg-cover bg-center bg-no-repeat flex items-center">
